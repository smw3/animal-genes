...
namespace AnimalGenes
{
    class Main_early : Mod
    {
        ...
        public override void DoSettingsWindowContents(Rect inRect)
        {
            ...
            listingStandard.CheckboxLabeled("Turn affinity + prerequisites into endogenes on transform", ref settings.EndogenifyAffinity, "When a pawn transforms, all existing endogenes are removed and replaced.");
